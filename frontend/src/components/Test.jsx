  ...
  import { addTestScore } from "@/redux/interviewFeedbackSlice";
  import { useDispatch,useSelector } from "react-redux";
  

    
    const TestPage = ({ questions = [], transcribedText,index,isProject }) => {
    ...
    const dispatch = useDispatch();
      ...
      const handleSubmit = async () => {
        ...
        try {
          ...
          console.log("RatingArray:", result.result.ratings);
        
          if (result.result?.ratings && Array.isArray(result.result.ratings)) {
            dispatch(addTestScore(result.result.ratings)); // Dispatch entire array at once
          }
          console.log("tesctfiahf",testScores);
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen  text-white p-6 w-[100%]">
          <div className="bg-white/10 border border-purple-500 p-6 rounded-2xl shadow-lg w-full max-w-lg text-center">
