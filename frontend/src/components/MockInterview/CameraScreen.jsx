...
const CameraScreen = ({ setTranscribedText }) => {
  ...
  return (
    <div className="w-[100%] flex m-20">
      <div className="bg-white/10 shadow-lg rounded-lg p-6 w-full max-w-lg">
        <ReactMediaRecorder
          video
          render={({ status, startRecording, stopRecording, mediaBlobUrl }) => (
            <div className="flex flex-col items-center">
              ...
              {parsedResult && (
                <div className="mt-4 text-left p-4 border bg-gray-300 border-gray-300 rounded-lg shadow">
